...
export const BUILTIN_EXERCISES = [
  ...
  { name: 'FORWARD ALTERNATING LUNGES', tip: 'Each lunge is 1 rep.', equipment: ['bodyweight'] },
  { name: 'MOUNTAIN CLIMBERS', tip: 'Keep hips low in your plank. Drive knees toward elbows.', equipment: ['bodyweight'] },
  ...
  { name: 'RUSSIAN TWISTS', tip: 'Each side is 1 rep. Lean back 45°.', equipment: ['bodyweight'] },
  { name: 'BICYCLE CRUNCHES', tip: 'Elbow to opposite knee. Slow and controlled.', equipment: ['bodyweight'] },
  { name: 'JUMPING AIR SQUATS', tip: 'Land soft. Drop straight into the next squat.', equipment: ['bodyweight'] },
  { name: 'REVERSE ALTERNATING LUNGES', tip: 'Step back, not forward. Counts both legs.', equipment: ['bodyweight'] },
  { name: 'TRICEP DIPS', tip: 'Use a chair or your weight bench. Elbows back, not flared.', equipment: ['bodyweight'] },
  ...
  { name: 'LEG RAISES', tip: 'Lower both legs slowly. Don\'t let feet touch the floor.', equipment: ['bodyweight'] },
  ...
  { name: 'DUMBBELL SHOULDER STRICT PRESS', tip: 'Shoulder to Overhead. Slight bend of the knees. Don\'t arch the back.', equipment: ['dumbbell'] },
  { name: 'LATERAL RAISES', tip: 'Go lighter than you think. Keep a slight bend in the elbows. Stop at shoulder height.', equipment: ['dumbbell'] },
  { name: 'DUMBBELL BENT OVER ROWS', tip: 'Each side = 1 rep. Pull to your hip.', equipment: ['dumbbell'] },
  { name: 'DUMBBELL LUNGES', tip: 'Counts both legs. DB\'s can be by your side or racked on shoulders.', equipment: ['dumbbell'] },
